# QwikSend Admin Panel — Deploy Guide

## 1. Push to GitHub

Create a new GitHub repo named `qwiksend-admin` and push this folder to it.

```bash
git init
git add .
git commit -m "init: qwiksend admin panel"
git remote add origin https://github.com/<your-username>/qwiksend-admin.git
...
2. Import your `qwiksend-admin` GitHub repo
...
3. Name it `qwiksend-kv`, select the same region as your project
...
| `LICENSE_SECRET` | `Zyq$7mKp9xLv2WnBd5tYs6hJfQe1cR8uAoVz3TGw` (must match QwikSend app's server.js) |
...
## 7. Integrate with QwikSend Desktop App (Online Validation)
...
## Validate Endpoint (called by QwikSend app)
